using Itura.AI.API.Middleware;
using Itura.AI.Application;
using Itura.AI.Infrastructure;
...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new OpenApiInfo
    {
        Title = "Itura AI API",
        Version = "v1",
        Description = "AI recommendations service for Itura platform"
    });
...
{
    app.UseSwagger();
    app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Itura AI API v1"));
}
